		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "주문내역 조회",
									"targetURL": "#synceaorderview-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synceaorderview-display": {
								"semanticObject": "synceaorderview",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.ea.orderview",
									"url": sap.ui.require.toUrl("sync/ea/orderview")
								}
							}
						}
					}
